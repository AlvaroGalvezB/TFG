...
export class ConductoresComponent {
  public conductores:{numero:string, piloto:string, puntos:string, nombrePiloto:string, bandera:string}[] = [
    {numero : "1", piloto : "maxver01", puntos:"161 PTS", nombrePiloto:"Max Verstappen", bandera:"Netherlands"},
    {numero : "16", piloto : "chalec01", puntos:"113 PTS", nombrePiloto:"Charles Leclerc", bandera:"Monaco"},
    {numero : "11", piloto : "serper01", puntos:"107 PTS", nombrePiloto:"Sergio Perez", bandera:"Mexico"},
    {numero : "4", piloto : "lannor01", puntos:"101 PTS", nombrePiloto:"Lando Norris", bandera:"United Kingdom"},
    {numero : "55", piloto : "carsai01", puntos:"93 PTS", nombrePiloto:"Carlos Sainz", bandera:"Spain"},
    {numero : "81", piloto : "oscpia01", puntos:"53 PTS", nombrePiloto:"Oscar Piastri", bandera:"Australia"},
    {numero : "63", piloto : "georus01", puntos:"44 PTS", nombrePiloto:"George Russell", bandera:"United Kingdom"},
    {numero : "44", piloto : "lewham01", puntos:"35 PTS", nombrePiloto:"Lewis Hamilton", bandera:"United Kingdom"},
    {numero : "14", piloto : "feralo01", puntos:"33 PTS", nombrePiloto:"Fernando Alonso", bandera:"Spain"},
    {numero : "22", piloto : "yuktsu01", puntos:"15 PTS", nombrePiloto:"Yuki Tsunoda", bandera:"Japan"},
    {numero : "18", piloto : "lanstr01", puntos:"11 PTS", nombrePiloto:"Lance Stroll", bandera:"Canada"},
